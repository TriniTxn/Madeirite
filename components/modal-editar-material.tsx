...
import { atualizarMaterial } from "@/app/estoque/actions"
...
export function ModalEditarMaterial({ material }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      await atualizarMaterial(formData)
      setAberto(false)
    } catch {
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-semibold text-white">Editar Material</h2>
